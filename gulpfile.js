...
function compileTwig() {
    return gulp.src(['./src/twig/templates/*.twig'])
    ...
    .pipe(data(function (file) {
        return JSON.parse(fs.readFileSync('./src/twig/data/' + path.basename(file.path) + '.json'));		
    }))
    .pipe(twig())
...
function watch() {
    ...
    gulp.watch(['src/twig/templates/**/*.twig','src/twig/data/*.twig.json'], compileTwig);
}
exports.style = style;
